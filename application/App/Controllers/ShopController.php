    ...
    public function detail(Request $request, Response $response, array $args = []): Response
    {
      ...
      else
      {
        ...
        if(isset($_POST['playerShop'])) {
          ...
          $apiResponse = $this->preferences->APIcall_POST($this->preferences->getApiServer(), $postData, $this->preferences->getApiToken()['access_token'], '/api/v1/players/'.$_POST['playerShop'].'/items/give');
